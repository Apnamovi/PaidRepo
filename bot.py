    ...
    if usr_cmd == "/start":
        ...
        if(Config.LAZY_MODE == True):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿 Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ", url="https://t.me/LuLuMixOfficial"),
                        InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/Laz")
                    ],
                    [
                        InlineKeyboardButton("🤖Aß⊕ut ß⊕†", callback_data="aboutbot"),
                        InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="jkqboss")
                    ]]))
        else :
            await cmd.reply_photo(photo=lazy_pic,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/LuLuMixOfficial"),
                        InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/Laz")
                    ],
                    [
                        InlineKeyboardButton("🤖Aß⊕ut ß⊕†", callback_data="aboutbot"),
                        InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="jk1boss")
                    ]]))
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Owner](https://t.me/jk1boss).",
                        disable_web_page_preview=True
                    )
                    return
