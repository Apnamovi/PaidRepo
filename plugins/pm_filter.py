...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>इधर आपको मूवी नहीं मिलेगी ग्रुप में मूवी मांगें\nGroup Link <a href=https://t.me/Apnamovie4>Click Here</a> 👈</b>")
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/jk1boss")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
